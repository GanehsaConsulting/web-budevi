        ...
        <>
            <div className="hidden md:block fixed bottom-5 right-5 z-[100]">
                <section className="flex flex-col gap-3 duration-300">
                    <button
                        onClick={scrollToTop}
                        className={`${isVisible ? "scale-100 " : 'scale-0 translate-y-full'} bg-baseColor bg-opacity-50 duration-300 backdrop-blur-md hover:bg-mainColor hover:text-baseColor dark:text-white text-mainColor rounded-full p-3 shadow-lg`}
                    >
