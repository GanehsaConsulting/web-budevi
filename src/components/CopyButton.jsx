...
Unit: ${selectedVariant.unit}
    ...
    return (
        <button onClick={handleCopyProduct} className={`${className} group-active:scale-90 btn-sm flex items-center gap-2 px-2 py-1 text-white group-hover:bg-[#0000006d] backdrop-blur-0 group-hover:backdrop-blur-lg bg-opacity-0 group-hover:bg-opacity-100 ease-in-out rounded-full translate-x-12 group-hover:translate-x-0 duration-300`}>
