"use client"
import { TbBoxMultiple1, TbBoxMultiple2, TbBoxMultiple3, TbBoxMultiple4, TbBoxMultiple5, TbBoxMultiple6, TbList } from "react-icons/tb";
    ...
    return (
        <>
            <section className="md:block hidden">
                <div className={`relative flex gap-1 w-fit bg-mainColorD dark:bg-darkColor rounded-full p-1`}>
