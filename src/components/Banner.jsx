            ...
            <section className="md:mx-10 mx-5 md:pt-[53px] pt-[43px] md:pb-[35px] pb-[10px]">
                <div className="relative rounded-xl md:rounded-2xl overflow-hidden group">
                    <Image
                        width={1000}
                        height={1000}
                        className="w-full h-[30lvh] md:h-[40lvh] object-cover dark:brightness-75 brightness-90"
                        ...
                        alt=""
                    />
                    <div className="rounded-none h-[50%] duration-300 group-hover:h-[150%] w-full gradient-blur bg-gradient-to-t from-[#916d3d4c] to-transparent"></div>
                    <div className="absolute bottom-3 left-3 md:bottom-5 md:left-5 md:w-[50%] text-white">
                        <h1 className="text-2xl md:text-4xl font-medium opacity-80 brightness-105">
                            Sinar Lotus
                        </h1>
